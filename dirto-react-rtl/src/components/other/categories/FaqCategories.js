                    ...
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            <Link to="#" className="d-block padding-top-30px padding-bottom-30px">
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">ابدء</span>
                            </Link>
                        </div>
                    </div>
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            ...
                            <g>
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">خطط التسعير</span>
                            </Link>
                        </div>
                    </div>
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            ...
                            <g>
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">سؤال مبيعات</span>
                            </Link>
                        </div>
                    </div>
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            ...
                            <g>
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">أدلة الاستخدام</span>
                            </Link>
                        </div>
                    </div>
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            <Link to="#" className="d-block padding-top-30px padding-bottom-30px">
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">معلومات</span>
                            </Link>
                        </div>
                    </div>
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            <Link to="#" className="d-block padding-top-30px padding-bottom-30px">
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">المعاملات</span>
                            </Link>
                        </div>
                    </div>
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            ...
                            <g>
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">بطاقة</span>
                            </Link>
                        </div>
                    </div>
                    <div className="col-lg-3 column-td-6">
                        <div className="category-item faq-cat-item p-0">
                            ...
                            <g>
                                ...
                                <span className="d-block font-size-18 font-weight-semi-bold mt-3">الحساب</span>
                            </Link>
                        </div>
                    </div>
                </div>
