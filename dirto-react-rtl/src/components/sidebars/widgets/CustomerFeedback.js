                    ...
                    <div className="review-content padding-top-45px padding-bottom-40px">
                        <div className="review-rating-summary">
                            ...
                            <div className="course-rating-text">
                                <p className="course-rating-text__text">تصنيف الغذاء</p>
                            </div>
                        </div>
                                ...
                                <ul>
                                    <li className="review-rating-rate__items">
                                        <div className="review-rating-inner__item">
                                            <div className="review-rating-rate__item-text">5 نجوم</div>
                                    ...
                                    <li className="review-rating-rate__items">
                                        <div className="review-rating-inner__item">
                                            <div className="review-rating-rate__item-text">4 نجوم</div>
                                            <div className="review-rating-rate__item-fill">
                                    ...
                                    <li className="review-rating-rate__items">
                                        <div className="review-rating-inner__item">
                                            <div className="review-rating-rate__item-text">3 نجوم</div>
                                            <div className="review-rating-rate__item-fill">
                                    ...
                                    <li className="review-rating-rate__items">
                                        <div className="review-rating-inner__item">
                                            <div className="review-rating-rate__item-text">2 نجوم</div>
                                            <div className="review-rating-rate__item-fill">
                                    ...
                                    <li className="review-rating-rate__items">
                                        <div className="review-rating-inner__item">
                                            <div className="review-rating-rate__item-text">1 نجوم</div>
                                            <div className="review-rating-rate__item-fill">
