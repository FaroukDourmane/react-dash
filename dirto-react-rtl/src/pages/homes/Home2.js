        ...
        return (
            <main className="home-2">
                ...
                <section className="cat-area destination-area padding-top-100px padding-bottom-100px">
                    <div className="container">
                        <div className="row section-title-width text-center">
                            <SectionsHeading title="اكتشف وجهة مشهورة" desc="غتنم كل يوم فرصة لتصبح مسلمًا أفضل. والله أعلم ما هو الأفضل لك ومتى يكون الأفضل لك.غتنم كل يوم فرصة لتصبح مسلمًا أفضل. " />
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="button-shared mt-4 text-center">
                                    <Button text="عرض كل الوجهة" url="/all-locations">
                                        <span className="la">
                                            <BsEye />
                                        </span>
                                    </Button>
                ...
                <section className="card-area padding-top-100px padding-bottom-90px text-center">
                    <div className="container">
                        <div className="row section-title-width text-center">
                            <SectionsHeading title="الأماكن التي نوصي بزيارتها" desc="غتنم كل يوم فرصة لتصبح مسلمًا أفضل. والله أعلم ما هو الأفضل لك ومتى يكون الأفضل لك.غتنم كل يوم فرصة الأفضل لك ومتى يكون الأفضل لك. " />
                        </div>
                        <RecommendedPlace />
                    </div>
                </section>
                ...
                <section className="funfact-area section-bg-2 padding-top-100px padding-bottom-50px text-center">
                    <div className="container">
                        <div className="row section-title-width text-center">
                            <SectionsHeading title="الأرقام تقول كل شيء" titleClass="text-white" desc="اغتنم كل يوم فرصة لتصبح مسلمًا أفضل. والله أعلم ما هو الأفضل لك ومتى يكون الأفضل  والله أعلم ما هو الأفضل لك ومتى يكون الأفضل لك. " />
                        </div>
                ...
                <section className="hiw-area padding-top-100px padding-bottom-80px after-none text-center">
                    <div className="container">
                        <div className="row section-title-width text-center">
                            <SectionsHeading title="ماذا نقدم" desc="اغتنم كل يوم فرصة لتصبح مسلمًا أفضل. والله أعلم ما هو الأفضل لك ومتى يكون الأفضل  والله أعلم ما هو الأفضل لك ومتى يكون الأفضل لك. " />
                        </div>
                ...
                <section className="author-area padding-top-100px padding-bottom-100px">
                    <div className="container-fluid">
                        <div className="row section-title-width text-center">
                            <SectionsHeading title="تعرف على أفضل المؤلفين" titleClass="text-white" desc="اغتنم كل يوم فرصة لتصبح مسلمًا أفضل. والله أعلم ما هو الأفضل لك ومتى يكون الأفضل والله أعلم ما هو الأفضل لك ومتى يكون الأفضل لك." />
                        </div>
                ...
                <section className="testimonial-area padding-top-100px padding-bottom-100px text-center">
                    <div className="container">
                        <div className="row section-title-width text-center">
                            <SectionsHeading title="ماذا قال مستخدمينا" desc="اغتنم كل يوم فرصة لتصبح مسلمًا أفضل. والله أعلم ما هو الأفضل لك ومتى يكون الأفضل والله أعلم ما هو الأفضل لك ومتى يكون الأفضل لك." />
                        </div>
                        <div className="row">
                    ...
                    <div className="container">
                        <div className="row section-title-width section-title-ml-mr-0">
                            <div className="col-lg-8">
                                <SectionsHeading title="أحدث النصائح والمقالات" desc="غتنم كل يوم فرصة لتصبح مسلمًا أفضل. والله أعلم ما هو الأفضل لك ومتى يكون الأفضل لك." />
                            </div>
                            <div className="col-lg-4">
                                <div className="btn-box h-100 d-flex align-items-center justify-content-end">
                                    <Button text="مشاهدة كل المنشورات" url="/blog-grid" className=" margin-top-100px" />
                                </div>
                            </div>
                        </div>
